...
if($_GET['mode'] == "a")
{
	...
	{
		$image = imagecreatefrompng("https://yourhosting.com/avatari/noavatar.png");
	...
	else
	{
		...
		$imagepath = "https://yourhosting.com/admin/avatari/{$id}.{$ext}";
...
else if($_GET['mode'] == "c")
{
	...
	else
	{
		...
		$imagepath = "https://yourhosting.com/avatari/{$id}.{$ext}";
