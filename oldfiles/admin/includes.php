...
function srvgrafik($ip, $port) {
	...
	$grafik = '<span class="autor" data-selector="true" data-content="<img src=\'https://yourhosting.com/grafik/'.$ipport.'.png\' />" style="color: #95A1AB">' . $ip . ':<m>' . $port . '</m></span>';
...
function admin_avatar($id) {
	...
	return "https://yourhosting.com/admin/avatari/{$av}";	
}
...
function user_avatar($id) {
	...
	return "https://yourhosting.com/avatari/{$query[avatar]}";	
}
