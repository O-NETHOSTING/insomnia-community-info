                                    ...
                                    <div id="freq<?php echo $row['id']; ?>" style="cursor: default;" <?php if($row['status']==1) echo ' class="unread"'; ?>>
                                        <li>
                                            <table>
                                                <tr valign="top">
                                                    <td width="55">
                                                        <img style="margin: -8px;" width="55" height="55" src="https://yourhosting.com/avatar.php?mode=c&id=<?php echo $row['user_one']; ?>" />
                                                    </td>
                                                    <td>
...
?>
    ...
    ?>
                        <a href="https://yourhosting.com/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=en">
    ...
    <?php
                        ...
                        <a href="https://yourhosting.com/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=sr">
