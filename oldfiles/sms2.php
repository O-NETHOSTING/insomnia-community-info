<?php
  ...
  // check the signature
  $secret = '0f021558115d38425a263b1da58bdc6f'; // insert your secret between ''
...
// only grant virtual credits to account, if payment has been successful.
 if(preg_match("/OK/i", $_GET['status'])
  ...
  $reply = "Cigo naiđe na gomilu skinhedsa, a oni mu kažu:
Cigo, dođi da ti nešto kažemo A tek će Ciga Pa ne moram ja sve da znam.
";
