            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <input type="hidden" name="item_name" value="yourhosting.com.info Payment Add Funds">
                        ...
                        <?php
                            ...
                            echo '<input type="hidden" name="notify_url" value="https://yourhosting.com/paypal/paypal_payment.php" />';
                            else
                            echo '<input type="hidden" name="notify_url" value="https://yourhosting.com/paypal/paypal_payment.php" />';


                        ?>
                        <input type="hidden" name="cancel_return" value="https://yourhosting.com/ucp-billingadd.php?tip=paypalcancel" />
                        <input type="hidden" name="return" value="https://yourhosting.com/ucp-billingadd.php?tip=paypalsuccessfunds" />

                        <input type="hidden" name="cbt" value="Back to YOUR Hosting" />
                        <input type="hidden" name="no_note" value="1" />
                        <input type="hidden" name="no_shipping" value="1" />
                        <input type="hidden" name="cs" value="1" />
                        <input type="hidden" name="cpp_header_image" value="https://yourhosting.com/assets/blue/img/logo2.png" />
