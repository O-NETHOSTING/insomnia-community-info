<?php
$fajl = "login";
include("/home/admin/web/yourhosting.com/public_html/konfiguracija.php");
include("/home/admin/web/yourhosting.com/public_html/admin/includes.php");
require_once('/home/admin/web/yourhosting.com/public_html/includes/libs/lgsl/lgsl_class.php');
require("/home/admin/web/yourhosting.com/public_html/includes/libs/phpseclib/SSH2.php");
require_once("/home/admin/web/yourhosting.com/public_html/includes/libs/phpseclib/Crypt/AES.php");

$servers = mysql_query("SELECT * FROM serveri");

while($row = mysql_fetch_assoc($servers))
{
	file_get_contents("https://yourhosting.com/admin/srv-grafik.php?id={$row[id]}&cron=C#3gtQ@");
	file_get_contents("https://yourhosting.com/gp-srvgrafik.php?id={$row[id]}&cron=aX21$%@");
	file_get_contents("https://yourhosting.com/gp-banner.php?id={$row[id]}&cron=6123saxhGASD");
}
