		...
		<tr>
			<td>
				...
				<div id="infos">
					...
					<p id="h2"><i class="icon-bar-chart"></i> <?php echo $jezik['text386']; ?>: <a target="_BLANK" href="https://yourhosting.com/grafik/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png"><z style="font-size: 9px;">https://yourhosting.com/grafik/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png</z></a></p>
				</div>							
			</td>
